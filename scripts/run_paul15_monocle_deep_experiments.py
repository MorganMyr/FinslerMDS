...
def variant(name, *, density_gamma, path):
    path_summary = {
        "max_iter": path["max_iter"],
        "inner_iter": path["inner_iter"],
        "local_weight": path["local_weight"],
        "n_global_landmarks": path["n_global_landmarks"],
        "max_global_targets_per_source": path["max_global_targets_per_source"],
        "n_local_neighbors": path["n_local_neighbors"],
    }
    return {
        "name": name,
