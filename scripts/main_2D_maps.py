...
def main_river():
    ...
    utils.set_window_title(fig_river, "River: Randers field")
    ...
    utils.set_window_title(fig_river_current, "River: current field")
    c = plt.cm.jet(X[:, 0] / (X[:, 0].max() - X[:, 0].min()))
    ...
    utils.set_window_title(fig_dists, "River: Randers geodesic distances")
    ...
    proj_smacof_f_unif, _ = fit_finsler_mds(
        ...
        weight=unif_weights*1., max_iter=max_iter,
    ...
    utils.set_window_title(fig_smacof_f_unif, f"River: Finsler-MDS alpha={randers_w_alpha_embedding}")
...
def main_sea():
    ...
    # Plot map
    fig, ax = plt.subplots()
    utils.set_window_title(fig, "Sea: Randers field")
    c = plt.cm.jet(X[:, 0] / (X[:, 0].max() - X[:, 0].min()))
    ...
    utils.set_window_title(fig_current, "Sea: current field")
    c = plt.cm.jet(X[:, 0] / (X[:, 0].max() - X[:, 0].min()))
    ...
    fig_dists, ax_dists = plt.subplots()
    utils.set_window_title(fig_dists, "Sea: Randers geodesic distances")
    im = ax_dists.imshow(dists_f)
    ...
    utils.set_window_title(fig_smacof_f_unif, f"Sea: Finsler-MDS alpha={randers_w_alpha_embedding}")
