...
def main_binary_tree():
    ...
    utils.set_window_title(fig_binary_tree_depth_connec_aswithout, "Binary tree: horizontal edges, original layout")
    ...
    utils.set_window_title(fig_binary_tree_depth_connec_with, "Binary tree: horizontal edges, spring layout")
    ...
    utils.set_window_title(fig_binary_tree_isomap, "Binary tree: Isomap")
    ...
    proj_smacof_f_unif, _ = fit_finsler_mds(
        dists, metric=RandersMetric(alpha=randers_w_alpha_embedding), optimizer="smacof_randers",
    ...
    utils.set_window_title(fig_binary_tree_smacof_f_unif, f"Binary tree: Finsler-MDS alpha={randers_w_alpha_embedding}")
    ...
    utils.set_window_title(fig_binary_tree_umap, "Binary tree: UMAP")
    ...
    utils.set_window_title(fig_binary_tree_tsne, "Binary tree: t-SNE")
