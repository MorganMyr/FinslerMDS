"""Comparison plots for PCA-init and diffmap-init Paul15 geodesic MDS."""
...
def main():
    ...
    dir_pca = dir_res / "experiments_PCA" / "aggressive"
    ...
    pca_name = "aggr_from_g1p0_lw0p5_to_g1p25_lw0p25_m60_i3_n70_nnk32_b8_gr0p45"
    ...
    make_cross_pseudotime_grid(
        ...
        output_path=dir_pca / "umap_vs_geodesic_mds_pca_pseudotime.pdf",
    )
    ...
    make_cross_pseudotime_grid(
        ...
        output_path=dir_pca / "geodesic_mds_pca_vs_diffmap_pseudotime.pdf",
    )
