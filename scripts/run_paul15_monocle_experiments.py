        ...
        },
        {
            ...
            "path": {
                **common,
                "max_iter": 3,
                "inner_iter": 2,
                "n_global_landmarks": 50,
                "max_global_targets_per_source": 80,
                "n_local_neighbors": 60,
                "local_weight": 100.0,
            },
        },
...
def run_variant(variant, dir_raw, dir_exp, input_dir, bridge_script, cell_ids, umap, pt_umap, seed):
    ...
    row.update({
        ...
        "max_iter": variant["path"]["max_iter"],
        "inner_iter": variant["path"]["inner_iter"],
        "local_weight": variant["path"]["local_weight"],
        "n_global_landmarks": variant["path"]["n_global_landmarks"],
        "n_local_neighbors": variant["path"]["n_local_neighbors"],
    })
